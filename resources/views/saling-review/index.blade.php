            ...
            <button
                ...
                <svg class="w-5 h-5" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        class="fill-white group-hover:fill-black transition-all ease-in-out" />
                </svg>
            </button>
        </div>
        {{-- <div class="flex flex-col gap-5 my-5 max-h-[600px]" data-simplebar> --}}
                ...
                <div
                    ...
                    <div class="flex gap-5 items-center">
                        ...
                        <div class="flex flex-col">
                            <p class="font-medium text-lg">Itamara Shofinia Weladis Aini</p>
                            <p class="text-grayScale-500">200535626862</p>
                        </div>
                    </div>

@if (!in_array(Route::currentRouteName(), ['latihan', 'saling-review']))
    <div id="navbar" class="shadow-md sticky top-0 z-50 container-nav flex justify-between items-center bg-primary">
        ...
        <!-- Profile and Logout -->
        <div class="relative">
            <button id="profile" class="flex items-center gap-2 ring-0 hover:ring-4 hover:ring-blue-400 transition-all ease-in-out rounded-full">
                <img src="{{ asset('assets/images/profile/default-profile.png') }}" alt="Profile" class="w-8 h-8 rounded-full">

@if (in_array(Route::currentRouteName(), ['saling-review']))
        ...
        <div class="flex gap-3 items-center">
            ...
            <div class="flex gap-3 items-center">
                ...
                <div class="flex flex-col w-full">
                    <p class="text-xs">Itamara Shofinia Weladis Aini</p>
                    <p class="text-lg font-semibold text-primary">Saling Review</p>
